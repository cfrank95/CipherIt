/*---------------------------------------------------------
 file: ImageCipher.java
   by: Adam Paul, Jaden Williams,
       Christopher Frank, Joseph Morelli
  for: Class that handles the encryption of images and
...
/**
 * The ImageCipher class contains the physical logic for encrypting an image
 */
public class ImageCipher extends Application {
  ...
  /**
   * setter for original image
   *
   * @param originalImage - new value of originalImage being passed in
   */
  ...
  /**
   * getter for original image of an encrypted image
   *
  ...
  /**
   * setter for ciphered image
   *
   * @param cipheredImage - new value of cipheredImage being passed in
   */
  ...
  /**
   * getter for ciphered image
   *
   * @return the ciphered image
   */
  ...
  /**
   * Creates a stage and scrambles
   *
   * @param cipherStage - stage for encrypted image
   */
  @Override
